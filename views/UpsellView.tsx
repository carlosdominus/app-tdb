...
const KITS = [
  {
    ...
    badge: 'KIT INICIAL',
    badgeColor: 'bg-black',
    image: 'https://novidadesdeagora.site/ltc/front/images/3potes_converted.webp',
    oldPrice: 'R$ 497,00',
    price: 'R$ 197,00',
    savings: 'R$300',
  ...
  },
  {
    ...
    image: 'https://novidadesdeagora.site/ltc/front/images/5potes_converted.webp',
    oldPrice: 'R$ 797,00',
    price: 'R$ 297,00',
    savings: 'R$500',
    featured: true,
  ...
  },
  {
    ...
    badge: 'MELHOR CUSTO',
    badgeColor: 'bg-black',
    image: 'https://novidadesdeagora.site/ltc/front/images/10potes_converted.webp',
    oldPrice: 'R$ 1.297,00',
    price: 'R$ 559,90',
    savings: 'R$737',
